...
tput cup 6 30
echo -e "\x1b[42m TECH KNOW LINUX by RANA \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you subscribe my channel TECH KNOW LINUX by RANA (y/n)? \e[m "
read answer
...
tput cup 20 0
figlet -f slant "TECH KNOW LINUX by RANA" |lolcat
echo " "
echo " "
