...
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO RANA TOOLS  \e[m "
echo
...
echo " "
echo " 
       <─────────────── [ Re-Coded by =*•.¸♡ Rana Nadeem Rajput ♡¸.•* ] ───────────────>            
                                                               " |lolcat
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY RANA\e[m "
...
tput cup 6 30
echo -e "\x1b[42m Rana Official Hacker's TECH KNOW LINUX channel \x1b[m"
tput cup 9 0
...
tput cup 20 0
figlet -f slant "RANA's TECH KNOW LINUX" |lolcat
echo " "
echo " "
#done setting up
